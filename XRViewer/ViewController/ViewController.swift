...
class ViewController: UIViewController, UIGestureRecognizerDelegate, GCDWebServerDelegate {
    ...
    func setupARKController() {
        ...
        // Tony (6/6/19): The original intent of the 'develop-onJSFinishedRendering' branch was to transition the
        // ARKController to Metal to reduce the effect of WebXR content being rendered 1+ frames behind, which
